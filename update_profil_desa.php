...
<body>
      ...
      <div class="text-component text--right">
        ...
        <div class="carousel-inner">
        	<div class="item active">
            	<img src="gambar1.jpg" alt="Slide 1" style="height:300px; width:800px;">
                <div class="carousel-caption">
                	<h3>Kantor Desa Sitoluama</h3>
 ...
 <a class="btn btn-primary btn-lg" href="#" role="button" style="width:80px; hei2ght:0px; ">Edit</a>          
  <a class="btn btn-danger btn-lg" href="#" role="button" style="width:80px; hei2ght:0px; ">Save</a>
        </div>
